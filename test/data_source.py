...
root_png = "E:/yuanxiaohan/Cardic_segmentation/data/"
#bg_out_dir = "F:\\XiaohanYuan_Data\\muticlass_mini\\train\\images"
mask_out_dir_masks = "E:/yuanxiaohan/Cardic_segmentation/data/chnxiaoqing/100/masks"
mask_out_dir_masks_visualize = "E:/yuanxiaohan/Cardic_segmentation/data/chnxiaoqing/100/masks_visualize"
...
for pair in [["chnxiaoqing", "01"]]:
    ...
    for time in ["100"]:
        ...
        for index in range(mask.shape[2]):
            img = mask[:, :, index]
            cv2.imwrite(mask_out_dir_masks + "\\" + pnumber + "_" + time + "_" + changenum(index + 1) + ".png", img)
        ...
        for index in range(mask.shape[2]):
            img = mask[:, :, index]
            cv2.imwrite(mask_out_dir_masks_visualize + "\\" + pnumber + "_" + time + "_" + changenum(index + 1) + ".png", img)
