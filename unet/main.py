# from unetpp import NestedUNet #unet++
...
if __name__ == "__main__":
    ...
    # Dataset begin
    # train = DataTrain(
    #     'F:/XiaohanYuan_Data/muticlass_mini/train/images', 'F:/XiaohanYuan_Data/muticlass_mini/train/masks')  # train data
    # val = DataVal(
    #     'F:/XiaohanYuan_Data/muticlass_mini/val/images', 'F:/XiaohanYuan_Data/muticlass_mini/val/masks')  # val data
    train = DataTrain(
...
# Model
    ...
    for i in range(epoch_start, epoch_end):
        ...
        if (i+1) % 5 == 0:
            ...
            if (i+1) % 20 == 0:  # save model every 20 epoch 每20代输出一次模型
