...
class DataTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_as_img = Image.open(single_image_name) #读某张图片,[512,512]
        # img_as_img.show()
        ...
        img_as_np = np.expand_dims(img_as_np, axis=0)  # add additional dimension,[1,512,512]
        ...
        msk_as_np = np.expand_dims(msk_as_np, axis=0)  # add additional dimension[1,512,512], 如果是用crossentropyloss就注释掉这行[512,512]
